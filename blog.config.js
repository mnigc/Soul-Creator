...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'hexopro', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Soul Creator', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '没有一棵树能长至天堂，除非它的根扎入地狱', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://soul-creator.netlify.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'soul,creator', // 网站关键词 英文逗号隔开
